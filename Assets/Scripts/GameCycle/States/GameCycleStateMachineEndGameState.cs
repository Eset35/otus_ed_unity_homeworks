...
{
    public class GameCycleStateMachineEndGameState : GameCycleStateMachineBaseState
    {
        public GameCycleStateMachineEndGameState(GameCycleStateMachine stateMachine) : base(stateMachine)
        {
        }
